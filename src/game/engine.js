...
import {
  ...
  now,
  BALANCE_PET_BASE,
  BALANCE_PET_SPAN_REF,
  BALANCE_UPGRADE_SPAN_REF,
  BALANCE_PET_AUTOCLICK_INCOME,
  BALANCE_CLICK_BOSS_CHIP,
  CRIT_DAMAGE_MULT,
  JACKPOT_DAMAGE_MULT,
  PET_JACKPOT_BOOST_MULT,
} from "../config.js";
import { stages, PHASE_UNLOCK_STAGES } from "../data/stages.js";
...
import {
  ...
  PET_MAX_LEVELS,
  PET_SCALE_PER_LEVEL,
  PET_RARITY_COST_MULT,
} from "../data/pets.js";
import { eggs } from "../data/eggs.js";
import { finiteNumber, formatNumber, hashText } from "../utils.js";
...
durationMax: 180
  ...
  function resumeGameAfterAd() {
    ...
    if (audioContext && audioContext.state === "suspended" && state.sound) {
      audioContext.resume();
    }
  }
